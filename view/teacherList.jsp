...
//  		        {field:'sn',title:'工号',width:150, sortable: true},    
 		        ...
 		        {field:'qq',title:'邮箱',width:150},
 		       	{field:'clazz_id',title:'实验室',width:150, 
	    ...
	    $("#delete").click(function(){
        	...
        	if(selectLength == 0){
            	...
            	$.messager.confirm("消息提醒", "将删除与导师相关的所有数据，确认继续？", function(r){
            		if(r){
            			$.ajax({
							type: "post",
...
<body>
	...
	<div id="toolbar">
		...
		<div style="float: left; margin-top: 4px;"
			...
			&nbsp;&nbsp;姓名：<input id="search_student_name" class="easyui-textbox"
				name="search_student_name" />
		</div>
		<div style="margin-left: 10px; margin-top: 4px;">
			实验室：<input id="clazzList" class="easyui-textbox" name="clazz" /> <a
	...
	<div id="addDialog" style="padding: 10px;">
		...
		<form id="addForm" method="post">
			<table id="addTable" border=0
				...
				<tr>
					<td style="width: 40px">实验室:</td>
					<td colspan="3"><input id="add_clazzList"
				...
				<tr>
					<td>姓名:</td>
					<td colspan="4"><input id="add_name"
						style="width: 200px; height: 30px;" class="easyui-textbox"
						type="text" name="name"
				...
				<tr>
					<td>密码:</td>
					<td colspan="4"><input id="add_password"
						style="width: 200px; height: 30px;" class="easyui-textbox"
				...
				<tr>
					<td>性别:</td>
					<td colspan="4"><select id="add_sex" class="easyui-combobox"
				...
				<tr>
					<td>电话:</td>
					<td colspan="4"><input id="add_phone"
						style="width: 200px; height: 30px;" class="easyui-textbox"
						type="text" name="phone" validType="mobile" /></td>
				</tr>
				<tr>
					<td>邮箱:</td>
					<td colspan="4"><input id="add_qq"
						style="width: 200px; height: 30px;" class="easyui-textbox"
						type="text" name="qq" validType="qq" /></td>
				</tr>
			</table>
		</form>
	</div>
	...
	<div id="editDialog" style="padding: 10px">
		...
		<form id="editForm" method="post">
			<table id="editTable" border=0
				...
				<tr>
					<td style="width: 40px">实验室:</td>
					<td colspan="3"><input id="edit_clazzList"
						style="width: 200px; height: 30px;" class="easyui-textbox"
						name="clazzid" /></td>
					<td style="width: 80px"></td>
				</tr>
