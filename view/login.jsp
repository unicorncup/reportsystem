...
<title>登录|周报告管理系统</title>
<meta name="keywords" content="周报告管理系统">
</head>
<body>

	<div class="header" style="padding: 0;">
		<h2
			style="color: white; width: 400px; height: 60px; line-height: 60px; margin: 0 0 0 30px; padding: 0;"></h2>
	</div>
			...
			<form id="form" class="form form-horizontal" method="post">
				<div class="row cl">
					...
					<div class="formControls col-8">
						<input id="" name="account" type="text" placeholder="账号"
