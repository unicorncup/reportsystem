...
//  		        {field:'sn',title:'学号',width:200, sortable: true},    
	    ...
	    $("#delete").click(function(){
        	...
        	if(selectLength == 0){
            	...
            	$.messager.confirm("消息提醒", "将删除该学生的所有信息，确认继续？", function(r){
            		if(r){
            			$.ajax({
							type: "post",
	...
	<div id="addDialog" style="padding: 10px">
		...
		<form id="addForm" method="post">
			<table cellpadding="8">
				...
				<tr>
					<td>电话:</td>
					<td><input id="add_phone" style="width: 200px; height: 30px;"
				...
				<tr>
					...
					<td><input id="add_qq" style="width: 200px; height: 30px;"
						class="easyui-textbox" type="text" name="qq" validType="qq" /></td>
				</tr>
				<tr>
					<td>实验室:</td>
	...
	<div id="editDialog" style="padding: 10px">
		...
		<form id="editForm" method="post">
			...
			<table cellpadding="8">
				...
				<tr>
					<td>电话:</td>
					<td><input id="edit_mobile"
						style="width: 200px; height: 30px;" class="easyui-textbox"
						type="text" name="mobile" validType="mobile" /></td>
				</tr>
				<tr>
					<td>导师:</td>
