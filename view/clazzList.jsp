	...
	$(function() {	
	    ...
	    $('#dataList').datagrid({ 
	        ...
	        columns: [[  
				{field:'chk',checkbox: true,width:50},
 		        ...
 		        {field:'name',title:'实验室名称',width:200},
 		        {field:'info',title:'实验室介绍',width:100, 
 		        },
	 		]], 
	        toolbar: "#toolbar"
	    }); 
	    ...
	    $("#delete").click(function(){
        	...
        	if(selectRow == null){
            	...
            	$.messager.confirm("消息提醒", "将删除实验室信息（如果实验室下存在学生或导师则不能删除），确认继续？", function(r){
            		if(r){
            			$.ajax({
							type: "post",
			...
			<table cellpadding="8">
				...
				<tr>
					...
					<td><textarea id="info" name="info"
							style="width: 200px; height: 60px;" class=""></textarea></td>
				</tr>
			</table>
		</form>
	</div>
